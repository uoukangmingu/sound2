const sounds = [
    { name: "1장(1)<br>[결혼식] 욕망의 정점", file: "1장(1) [결혼식] 욕망의 정점.mp3" },
    { name: "1장(2) [NA] 수상한 그 남자, 기억조작", file: "1장(2) [NA] 수상한 그 남자, 기억조작.mp3" },
    { name: "1장(3,4) [M,계] 깨져버린 유리잔, 비 속에서의 회고", file: "1장(3,4) [M,계] 깨져버린 유리잔, 비 속에서의 회고.mp3" },
    { name: "1장(5) [암전]", file: "1장(5) 암전.mp3" },
    { name: "2장(1) [암전] 의혹", file: "2장(1) [암전] 의혹.mp3" },
    { name: "3장(1) [암전] 검은색 진실", file: "3장(1) [암전] 검은색 진실.mp3" },
    { name: "4장(1) [NA] 보이지 않는 눈, 내게 닥친 비극", file: "4장(1) [NA] 보이지 않는 눈, 내게 닥친 비극.mp3" },
    ...
    { name: "7장(2) 7장(2) [까마귀]", file: "7장(2) [까마귀].mp3" },
