const sounds = [
    { name: "1장(1) [결혼식] 오르골의 비밀", file: "1장(1) [결혼식] 오르골의 비밀mp3.mp3" },
    ...
    { name: "2장(1) [암전] 무슨 일이 생길 것 같아", file: "2장(1) [암전] 무슨 일이 생길 것 같아.mp3" },
    { name: "3장(1) [암전] 의혹", file: "3장(1) [암전] 의혹.mp3" },
    { name: "4장(1) [NA] 왜 나를 피하는거야, 내게 닥친 비극", file: "4장(1) [NA] 왜 나를 피하는거야, 내게 닥친 비극.mp3" },
    { name: "4장(2) [암전] 낡은 빗소리", file: "4장(2) [암전] 낡은 빗소리.mp3" },
    { name: "5장(0) [휴지] 의심", file: "5장(0) [휴지] 의심.mp3" },
